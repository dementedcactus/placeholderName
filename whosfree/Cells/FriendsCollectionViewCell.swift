...
class FriendsCollectionViewCell: UICollectionViewCell {
    ...
    private func setupCFImage() {
        ...
        friendImage.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 5).isActive = true
        friendImage.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -5).isActive = true
